...
$q = $pdo->query("SELECT * FROM `thread` WHERE `subject` = 'Sports' AND `Active` = 1 ORDER BY `created` DESC"); //change subject to whatever page youre on
...
<div class="jumbotron Background-themes">
  <div class="container">
    <div class="row">
	  <div class="col-sm-2">
  <img id="Jumbotron-logo" src="Logos/Logo1white.png">
  </div>
  <div class="col-sm-10">
  <h1 id="jumbotronheader" class="fadeInDownLong" style="top:0%;"> Get To The Point </h1>
  <p class="fadeInDownShort"> Talk sports. Win prizes. </p>
  </div>
  </div>
</div>
</div>
...
.Background-themes{
Background-color: hsl(225, 70%, 25%); /*hsl(225,70%,25%) is real good*/
}
      ...
      <div class="modal-body">
         <form action = "">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="username" id="UsernameModal" placeHolder="Username">
          </div>
          <div class="form-group">

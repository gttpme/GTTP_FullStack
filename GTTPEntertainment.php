...
$q = $pdo->query("SELECT * FROM `thread` WHERE `subject` = 'Entertainment' AND `Active` = 1 ORDER BY `created` DESC"); //change subject to whatever page youre on
...
<div class="jumbotron Background-themes">
  <div class="container">
    <div class="row">
	  <div class="col-sm-2">
  <img id="Jumbotron-logo" src="Logo1white.png">
  </div>
  <div class="col-sm-10">
  <h1 id="jumbotronheader" class="fadeInDownLong" style="top:0%;"> Get To The Point </h1>
  <p class="fadeInDownShort"> Talk Entertainment. Win prizes.</p>
  </div>
  </div>
</div> 
</div>
...
<div class="container"  style="padding-top: 20px">
  ...
  <div class="carousel-inner">
	...
	<div><p class="carouseltimers" id="Timer3"> </p></div>
      ...
      <img src="<?php echo $Query[2][7] ?>" alt="New York" <!--width="1100" height="500"-->
      <div class="carousel-caption">
...
.winnercontainer {
border:3px solid hsl(195, 75%, 60%);
...
.Background-themes{
Background-color: hsl(285, 100%, 35%);/*hsl(225,70%,25%) is real good*/
}

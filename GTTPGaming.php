...
$q = $pdo->query("SELECT * FROM `thread` WHERE `subject` = 'Gaming' AND `Active` = 1 ORDER BY `created` DESC"); //change subject to whatever page youre on
...
<div class="jumbotron Background-themes">
  ...
  <p class="fadeInDownShort"> Talk Gaming. Win prizes.</p>
  </div>
  </div>
</div>
</div>
...
.Background-themes{
Background-color: hsl(195, 75%, 60%);/*hsl(225,70%,25%) is real good*/
}

...
$q = $pdo->query("SELECT * FROM `thread` WHERE `subject` = 'Music' AND `Active` = 1 ORDER BY `created` DESC"); //change subject to whatever page youre on
...
<div class="jumbotron Background-themes">
  ...
  <p class="fadeInDownShort"> Talk Music. Win prizes.</p>
  </div>
  </div>
</div>
</div>
...
.Background-themes{
Background-color: hsl(0, 80%, 55%);/*hsl(225,70%,25%) is real good*/
}

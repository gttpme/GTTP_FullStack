...
$q = $pdo->query("SELECT * FROM `thread` WHERE `subject` = 'Cuisine' AND `Active` = 1 ORDER BY `created` DESC"); //change subject to whatever page youre on
...
<div class="jumbotron Background-themes">
  <div class="container">
    <div class="row">
	  <div class="col-sm-2">
  <img id="Jumbotron-logo" src="Logos/Logo1black.png">
  </div>
  <div class="col-sm-10">
  <h1 id="jumbotronheader" class="fadeInDownLong" style="top:0%;"> Get To The Point </h1>
  <p class="fadeInDownShort"> Talk Food. Win prizes.</p>
  </div>
  </div>
</div>
</div>
...
<div class="container"  style="padding-top: 20px">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="/Pages/CommentImages/<?php echo $Query[0][10] ?>" alt="Los Angeles">
      <div class="carousel-caption" id="image1" >
    ...
    <div class="carousel-item">
      ...
      <img src="/Pages/CommentImages/<?php echo $Query[1][10] ?>" alt="Chicago" >
	...
	<div><p class="carouseltimers" id="Timer3"> </p></div>
      ...
      <img src="/Pages/CommentImages/<?php echo $Query[2][10] ?>" alt="New York">
...
.carousel-text {
text-shadow: -1px 0 black, 0 2px black, 2px 0 black, 0 -1px white;
}
...
.winnercontainer {
border:3px solid 	hsl(100, 80%, 75%);
...
.Background-themes{
Background-color: hsl(100, 80%, 75%);/*hsl(225,70%,25%) is real good*/
}
